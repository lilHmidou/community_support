...
final class Version20240203222132 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tutorat (id INT NOT NULL, level_studies VARCHAR(30) NOT NULL, disabilty TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE tutorat ADD CONSTRAINT FK_717E22E3BF396750 FOREIGN KEY (id) REFERENCES user_tutorat (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tutorat DROP FOREIGN KEY FK_717E22E3BF396750');
